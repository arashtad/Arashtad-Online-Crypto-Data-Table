...
We have used the Sci-Fi Games UI Elements Pack repository to create the crypto prices table. Custom.css has been added to the css folder as well as the crypto.html
